               ...
               <View style={{position: "absolute", top: 0, left: 0, height: "100%", width: "100%", backgroundColor: "#000", zIndex: 100, opacity: 0.4}}>
                ...
                <View style={{position: "absolute", bottom: - windowWidth * 0.07, justifyContent: "center", alignItems: "center",left: 0, right: 0, alignSelf: "center" ,zIndex: 100}}>
                    <View style={{flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 15, backgroundColor: "#fff",elevation: 5 ,borderRadius: 100, paddingHorizontal: windowWidth * 0.04, paddingVertical: windowWidth * 0.025}}>
                        ...
                        <Text style={{fontFamily: FONTFAMILY.ABeeZee, color: COLORS.primary, fontSize: getFontSize(10)}}>20 pers. aiment ce bon plan</Text>
         ...
         <View style={{width: windowWidth * 0.9, alignSelf: "center"}}>
           <View style={{marginTop: windowWidth * 0.1}}>
              ...
              <View style={{marginTop: windowWidth * 0.02}}>
                ...
                <View style={{flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: windowWidth * 0.01}}>
                    <Text style={{fontFamily: FONTFAMILY.ABeeZee, color: COLORS.primary, fontSize: getFontSize(10)}}>Le 23 juin 2024 à partir de 18h</Text>
                    <View style={{flexDirection: "row", alignItems: "center",gap: 5}}>
                       <Text style={{fontFamily: FONTFAMILY.ABeeZee, color: COLORS.primary, fontSize: getFontSize(14), textDecorationLine: "line-through"}}>139 €</Text>
                       <Text style={{fontFamily: FONTFAMILY.ABeeZee, color: COLORS.primary, fontSize: getFontSize(24)}}>99 €</Text>
                    </View>
                </View>
              </View>
