...
const ButtonOutline = ({ title, onPress}) => {
  ...
  return (
    <TouchableOpacity onPress={onPress} style={{borderWidth: 1 ,borderColor: COLORS.primary, paddingHorizontal: windowWidth * 0.07, paddingVertical: windowWidth * 0.032, borderRadius: 8}}>
