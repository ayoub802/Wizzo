...
const AgendaCard = ({item}) => {
  ...
  return (
    <View style={{flexDirection: "row",flex: 1, marginBottom: windowWidth * 0.05,gap: 15 ,position: "relative" ,alignItems: "center",backgroundColor: COLORS.white, borderRadius: 16, paddingHorizontal: 12, paddingVertical: 12,    shadowColor: '#000',
